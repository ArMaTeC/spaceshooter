...
declare module "babylonjs-inspector/fluent/primitives/text" {
...
declare module INSPECTOR.SharedUIComponents {
     ...
     * @returns
     */
    export var VectorPropertyLine: React.FunctionComponent<VectorSliderProps & INSPECTOR.SharedUIComponents.PropertyLineProps>;
...
declare module INSPECTOR.SharedUIComponents {
        export type SyncedSliderLineProps<O, K> = INSPECTOR.SharedUIComponents.PropertyLineProps & Omit<INSPECTOR.SharedUIComponents.SyncedSliderProps, "value" | "onChange"> & {
        /**
         * String key
         */
        propertyKey: K;
...
declare module INSPECTOR.SharedUIComponents {
     ...
     * @returns A React element representing the property line with a switch
     */
    export var SwitchPropertyLine: React.FunctionComponent<INSPECTOR.SharedUIComponents.PropertyLineProps & any>;
...
declare module INSPECTOR.SharedUIComponents {
     ...
     * @returns Component wrapping a colorPicker component (coming soon) with a property line
     */
    export var ColorPropertyLine: React.FunctionComponent<ColorSliderProps & INSPECTOR.SharedUIComponents.PropertyLineProps>;
