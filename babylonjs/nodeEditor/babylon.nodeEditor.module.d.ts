...
declare module "babylonjs-node-editor/fluent/primitives/text" {
...
import { FunctionComponent } from "react";
export type SyncedSliderProps = Omit<any & any, "onChange" | "value"> & {
    /**
 ...
 */
export const Checkbox: FunctionComponent<any>;

}
declare module "babylonjs-node-editor/fluent/hoc/vectorPropertyLine" {
import { FunctionComponent } from "react";
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLine";
import { Vector4 } from "babylonjs/Maths/math.vector";
import { Vector3 } from "babylonjs/Maths/math.vector";
 ...
 * @returns
 */
export const VectorPropertyLine: FunctionComponent<VectorSliderProps & PropertyLineProps>;
export {};

}
declare module "babylonjs-node-editor/fluent/hoc/textPropertyLine" {
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLine";
import { FunctionComponent } from "react";
type TextProps = {
    value: string;
...
declare module "babylonjs-node-editor/fluent/hoc/syncedSliderLine" {
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLine";
...
declare module "babylonjs-node-editor/fluent/hoc/switchPropertyLine" {
 ...
 */
export const SwitchPropertyLine: FunctionComponent<PropertyLineProps & any>;

}
declare module "babylonjs-node-editor/fluent/hoc/propertyLine" {
...
export const LineContainer: FunctionComponent<PropsWithChildren>;
/**
 ...
 *
 */
export const PropertyLine: FunctionComponent<PropsWithChildren<PropertyLineProps>>;

}
declare module "babylonjs-node-editor/fluent/hoc/linkPropertyLine" {
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLine";
import { FunctionComponent } from "react";
type LinkProps = {
    value: string;
...
declare module "babylonjs-node-editor/fluent/hoc/colorPropertyLine" {
import { FunctionComponent } from "react";
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLine";
import { Color3 } from "babylonjs/Maths/math.color";
import { Color4 } from "babylonjs/Maths/math.color";
 ...
 */
export const ColorPropertyLine: FunctionComponent<ColorSliderProps & PropertyLineProps>;
export {};
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @returns Switch component
     */
    export var Switch: React.FunctionComponent<any>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @returns
     */
    export var Input: React.FunctionComponent<any>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @returns Checkbox component
     */
    export var Checkbox: React.FunctionComponent<any>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type VectorSliderProps = {
        vector: BABYLON.Vector3 | BABYLON.Vector4;
        min?: number;
        max?: number;
        step?: number;
    };
     ...
     * @returns
     */
    export var VectorPropertyLine: React.FunctionComponent<VectorSliderProps & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type SyncedSliderLineProps<O, K> = BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps & Omit<BABYLON.NodeEditor.SharedUIComponents.SyncedSliderProps, "value" | "onChange"> & {
        /**
         * String key
         */
        propertyKey: K;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @returns A React element representing the property line with a switch
     */
    export var SwitchPropertyLine: React.FunctionComponent<BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps & any>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    export var LineContainer: React.FunctionComponent<React.PropsWithChildren>;
    /**
     * A reusable component that renders a property line with a label and child content, and an optional description, copy button, and expandable section.
     *
     * @param props - The properties for the PropertyLine component.
     ...
     *
     */
    export var PropertyLine: React.FunctionComponent<React.PropsWithChildren<PropertyLineProps>>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @returns Component wrapping a colorPicker component (coming soon) with a property line
     */
    export var ColorPropertyLine: React.FunctionComponent<ColorSliderProps & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps>;
